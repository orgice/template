...
console.log(Object.keys(ramyun)); // ['이름', '물양', '익히는시간', '매운맛']
console.log(Object.values(ramyun)); // ['신라면', 550, 3, true]

// 키와 값을 같이 순회하고 싶을 때 활용하는 방법
for (const key of Object.keys(ramyun)) {
  console.log(`${key} : ${ramyun[key]}`);
}
